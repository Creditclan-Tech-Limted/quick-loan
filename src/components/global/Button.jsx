...
const classes = {
  red: {
    filled:
      "bg-red-600 hover:bg-red-700 text-white focus:ring-4 focus:ring-red-600 focus:ring-opacity-20",
    outlined:
  ...
  green: {
    filled:
      "bg-green-600 hover:bg-green-700 text-white focus:ring-4 focus:ring-green-600 focus:ring-opacity-20",
    outlined:
  ...
  primary: {
    filled:
      "bg-blue-500 hover:bg-blue-600 text-black focus:ring-4 focus:ring-blue-500 focus:ring-opacity-20",
    outlined:
      "border border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white focus:ring-4 focus:ring-blue-600 focus:ring-opacity-20",
  ...
  accent: {
    filled:
      "bg-orange-300 hover:bg-orange-400 text-black focus:ring-4 focus:ring-orange-600 focus:ring-opacity-20",
    outlined:
  ...
  black: {
    ...
    outlined:
      "border border-gray-400 text-gray-800 hover:bg-gray-100 focus:ring-4 focus:ring-gray-200",
      ...
      >
        {loading ? (
          <span className="mx-auto">
            <Loader
              size="sm"
              className={classNames(classes[color].loader[variant])}
            />
          </span>
        ) : (
          <>
